    ...
    setActiveChannel = (id) => {
        ...
        try {
            ...
            if (channel && channel.isText()) {
                ...
                logger.info(t("agent.messages.activeChannelSet", {
    ...
    farmLoop = async () => {
        ...
        try {
            ...
            for (const featureKey of shuffleArray(featureKeys)) {
                ...
                try {
                    const shouldRun = (await feature.condition({
                        agent: this,
                        t,
                    ...
                    this.cooldownManager.set("feature", feature.name, typeof res === "number" && !isNaN(res)
                        ? res
